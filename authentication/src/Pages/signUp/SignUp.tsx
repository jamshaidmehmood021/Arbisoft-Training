...
const SignUp: React.FC = () => {
  ...
  const getFormData = useCallback((event: FormEvent<HTMLFormElement>): SignUpFormData => {
  ...
  const onSubmit = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      try {
        const response: AxiosResponse = await apiCall('/signup', formData);
      ...
      <Card className={classes.card} variant="outlined">
        ...
        <Box component="form" onSubmit={onSubmit} className={classes.form}>
          ...
          <Typography sx={{ textAlign: 'center' }}>
            Already have an account?  <Link to="/" className={classes.link}>Sign in</Link>
          </Typography>
        </Box>
