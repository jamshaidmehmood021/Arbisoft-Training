...
const LogIn = () => {
  ...
  const handleGoogleSuccess = (response) => {
    ...
    dispatch(login({ ...mockGoogleResponse, isGoogleSignIn: true }));
  };
  ...
  return (
    <GoogleOAuthProvider clientId="1005671367413-uaeosf1ji0l3olnrip26ib2cpq2eq58u.apps.googleusercontent.com">
      <section>
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Don’t have an account yet? <button><Link to="/signUp">Sign Up</Link></button>
              </p>
            </div>
          </div>
        </div>
